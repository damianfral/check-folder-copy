        ...
        packages.deploy =
          pkgs.writeShellApplication
          {
            ...
            text = ''
              set -e
              echo Deploying
              aws s3 ls s3://check-folder-copy.damianfral.com/
              aws s3 rm s3://check-folder-copy.damianfral.com/*
              aws s3 sync ${packages.frontend} s3://check-folder-copy.damianfral.com/
            '';
          };
